...
if (!fs.existsSync(keyPath)) {
  ...
  console.error("");
  console.error(
    "  1. Allez sur https://console.firebase.google.com/project/ibe-construction-portal/settings/serviceaccounts/adminsdk",
  );
...
async function main() {
  ...
  const clientUser = await createOrGetUser(
    CLIENT_EMAIL,
    CLIENT_PASSWORD,
    CLIENT_NAME,
  );
  ...
  console.log(
    `     URL      : http://localhost:57637/portal/admin-login.html\n`,
  );
